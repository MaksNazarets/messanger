...
import { insertNewElement, isMessageVisible } from '/static/js/custom_functions.js'
...
socket.on('get_chat_data', (chat_data: AnyObject) => {
    ...
    const chat_name_wrapper = right_panel.querySelector('.chat-name_wrapper') as HTMLDivElement;
...
function insertDateDivider(before = false, beforeSibling?: Element) {
